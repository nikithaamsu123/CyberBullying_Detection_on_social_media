    ...
    <body class="login">
        ...
        <div id="facebook-Bar">
            <div id="facebook-Frame">
                <div align="center" id="logo" > <a href="#">Rule-Based Cyberbullying Detection on Social Media</a> </div>
        ...
        <div id="nav">
            ...
            <br></br><a href="admin_home.jsp">OFFENDER USER</a>
			<br><a href="b_user.jsp">BLOCKED USER DETAILS</a>
			<br><a href="b_add.jsp">ADD CYBERBULLYING WORDS</a><br>
                    ...
                    <br></br><h4 class="title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administrative</h4><img src="img\a22.jpg" alt="Mountain View" style="width:304px;height:228px;"></img>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <!--To do you work-->
                           <div style="border: 1px solid white; height: auto; border-top-width: 0px; border-bottom-width: 0px; width: 700px">

                                    <h3>OFFENDER USER DETAILS</h3><br>
                                    ...
                                    <table border="1" style="text-align: center;margin-left: 180px">
                                        <tr>
                                            ...
                                            <th style="text-align: center;width: 400px;">Cyberbullying Message</th>
